...
export class HowellLiquidityService {
  ...
  private readonly liquidityData: HowellLiquidityDataPoint[] = [
    ...
    },
    {
      date: "2025-06-02",
      rawDate: "2025-05-30",
      globalLiquidity: 179.15,
      shadowMonetaryBase: 107.97,
      collateralMultiplier: 1.66,
      isRevised: false,
    },
    {
